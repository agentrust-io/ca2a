...
- Developer Preview. One bound worth reading before you rely on it: peer appraisal has been demonstrated one-directional, so mutual simultaneous attestation is still outstanding. See [Limitations](https://ca2a.agentrust-io.com/LIMITATIONS/index.md).
...
1. **Runtime attestation.** A peer proves it is running attested, measured code before it is trusted with a delegated task.
