...
| [claim3-scope-policy-intersection](claim3-scope-policy-intersection/) | C3: Delegated scope intersected with local Cedar policy | gated (Tier 2) | SKIPs until runtime peer-delegation enforcement lands |
| [claim4-sealed-payload-confidentiality](claim4-sealed-payload-confidentiality/) | C4: Payload decrypts only inside the attested peer | gated (Tier 2) | Proves fail-closed today (`SealedChannelError`, no silent plaintext); confidentiality property pending |
